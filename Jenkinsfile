node {
    stage('Build') {
        sshagent(['production']) {
            ...
            sh "ssh -o StrictHostKeyChecking=no -l cloud 52.139.171.12 cd /home/cloud/a428-cicd-labs"
            sh "ssh -o StrictHostKeyChecking=no -l cloud 52.139.171.12 sudo docker build -t newreactimg ."
